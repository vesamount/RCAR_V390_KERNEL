...
static const struct cpg_core_clk r8a77965_core_clks[] __initconst = {
	...
	DEF_GEN3_SD("sd0",      R8A77965_CLK_SD0,   CLK_SDSRC,    0x0074),
	DEF_GEN3_SD("sd1",      R8A77965_CLK_SD1,   CLK_SDSRC,    0x0078),
	DEF_GEN3_SD("sd2",      R8A77965_CLK_SD2,   CLK_SDSRC,    0x0268),
	DEF_GEN3_SD("sd3",      R8A77965_CLK_SD3,   CLK_SDSRC,    0x026c),
